...
/* Create a modifer that checks if the msg.sender is the owner of the contract */
   ...
   */
  modifier forSale(uint _sku) {require(items[_sku].state == State.ForSale, "This item is not for sale"); _;}
  modifier sold(uint _sku) {require(items[_sku].state == State.Sold, "This item is not sold"); _;}
  modifier shipped(uint _sku) {require(items[_sku].state == State.Shipped, "This item is not shipped"); _;}
  modifier received(uint _sku) {require(items[_sku].state == State.Received, "This item is not received"); _;}
